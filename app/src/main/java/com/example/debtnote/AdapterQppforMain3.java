...
public class AdapterQppforMain3 extends ArrayAdapter<Qpp> {

    Activity context;
    int resource;
    List<Qpp> objects;

    public AdapterQppforMain3( Activity context, int resource,  List<Qpp> objects) {
    ...
    public View getView(int position,  View convertView,  ViewGroup parent) {
        ...
        txtQtyQpp.setText(" "+qpp.getQuantaty()+" Cái");
    ...
    private void actionBtnRemoveQpp(View view) {
        ((MainActivity3)this.context).actionRemoveQpp((Qpp) view.getTag());
    }
}
